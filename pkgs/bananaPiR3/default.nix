{
  ...
  _setSkipBuildCache = b: pkg: pkg.overrideAttrs (oa: { meta = oa.meta // { skipBuildCache = b; }; });
  linuxPackages_6_9_bananaPiR3 = linuxKernel.packagesFor (_setSkipBuildCache true (linux_6_9.override {
    kernelPatches = [
      {
  ...
  linuxPackages_6_9_bananaPiR3_minimal = linuxKernel.packagesFor (_setSkipBuildCache false (linuxPackages_6_9_bananaPiR3.kernel.override {
    autoModules = false;
